...
export default function MonthYearPicker({ month, year, onMonthChange, onYearChange }: MonthYearPickerProps) {
  ...
  return (
    <div className="relative flex-1 min-w-0" ref={panelRef}>
      <button
        type="button"
        onClick={() => {
          setOpen(!open);
        ...
        className="flex w-full h-auto items-center justify-center md:justify-start gap-2.5 rounded-xl border border-slate-300 bg-slate-50 px-4 py-2.5 text-sm text-slate-800 transition-colors hover:border-blue-400 hover:bg-blue-50 dark:border-gray-700 dark:bg-gray-950 dark:text-slate-100 dark:hover:border-blue-500 dark:hover:bg-blue-950/30 cursor-pointer"
      >
