  ...
  return (
    <div className="flex flex-col gap-6 p-4 md:p-6">
      <PageHero
        ...
        description="Atur bab dan materi pelajaran"
      />
          ...
          <div className="bg-white/70 dark:bg-gray-800/40 border border-white/20 dark:border-gray-700/50 shadow-lg rounded-2xl p-4 md:p-5">
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
              <div className="mb-3 md:mb-0">
                ...
                <Select
                  value={selectedGS}
                  onValueChange={(v) => v && setSelectedGS(v)}
                >
                ...
                <div className="flex flex-col-reverse sm:flex-col gap-2 h-full justify-end">
                  <div className="flex justify-end sm:justify-end">
                    {userRole !== null && userRole !== "guru" ? (
                      <Link
                        href="/kelola-mapel"
                        className="text-xs text-indigo-500 hover:text-indigo-700 dark:text-indigo-400 dark:hover:text-indigo-300 font-medium flex items-center gap-1 mt-2"
                      >
                        <Settings size={12} />
          ...
          {chaptersLoading ? (
            <div className="animate-pulse space-y-3">
              {[1, 2, 3].map((i) => (
                <div
                  key={i}
                  className="bg-white/70 dark:bg-gray-800/40 border border-white/20 dark:border-gray-700/50 shadow-lg rounded-2xl overflow-hidden"
                >
                    ...
                    {expandedChapter === chapter._id && (
                      <div className="border-t border-slate-100 dark:border-slate-700/50 px-4 py-3 pl-14 bg-slate-50/50 dark:bg-gray-900/30 space-y-2">
                        {chapter.inputMode === "per_material" ? (
                            ...
                            {materials === undefined ? (
                              <div className="animate-pulse space-y-2">
                                {[1, 2, 3].map((i) => (
                                  <div
                                    key={i}
                                    className="h-9 bg-slate-200 dark:bg-slate-700 rounded-lg"
                                  />
                                ))}
                              </div>
                              ...
                              <div className="space-y-1.5">
                                {sortedMaterials.map((mat, midx) => (
                                  ...
                                  >
                                    ...
                                    <button
                                      onClick={() =>
                                        openEditMaterial(chapter._id, mat)
                                      }
                          ...
                          <p className="text-sm text-slate-400 dark:text-slate-500 italic">
                            Bab ini menggunakan mode Per Bab — nilai langsung
                            diinput tanpa materi.
                          </p>
                        )}
                      </div>
                    )}
      ...
      <Modal
        ...
        title={chapterModal.edit ? "Ubah Bab" : "Tambah Bab"}
        className="max-w-sm"
      >
        <div className="space-y-4">
          ...
          <div>
            ...
            <Select
              ...
              onValueChange={(v) =>
                v && setChapterInputMode(v as "per_chapter" | "per_material")
              }
            >
              ...
              <SelectContent>
                <SelectGroup>
                  ...
                  <SelectItem value="per_material">
                    Per Materi (sub-bab)
                  </SelectItem>
                  <SelectItem value="per_chapter">
                    Per Bab (langsung)
                  </SelectItem>
                </SelectGroup>
              </SelectContent>
      ...
      <Modal
        ...
        title={materialModal.edit ? "Ubah Materi" : "Tambah Materi"}
        className="max-w-sm"
      >
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              autoFocus
              onKeyDown={(e) => {
                if (e.key === "Enter") handleSaveMaterial();
              }}
            />
          </div>
          <div className="flex justify-end gap-2">
      ...
      >
        <p className="text-slate-600 dark:text-slate-400 text-sm mb-4">
          ...
          {confirmDelete?.type === "chapter" ? "bab" : "materi"}{" "}
        ...
        <div className="flex justify-end gap-2">
          <button
            ...
            disabled={deleting}
            className="px-4 py-2 text-sm font-medium text-slate-700 dark:text-slate-300 bg-slate-100 dark:bg-gray-800 hover:bg-slate-200 dark:hover:bg-gray-700 disabled:opacity-50 disabled:cursor-not-allowed rounded-lg transition-colors cursor-pointer"
          >
            Batal
          </button>
          <button
