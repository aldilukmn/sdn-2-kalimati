...
export default function TabPresensi({
  ...
  const headers = (
    <>
      ...
      <th className="text-center px-4 py-3 font-semibold whitespace-nowrap w-40">Rata-rata Presensi</th>
  ...
  return (
    <ScoreTableWrapper
      ...
      empty={paginatedPresensiStudents.length === 0}
      emptyMessage="Belum ada data presensi untuk kelas ini."
