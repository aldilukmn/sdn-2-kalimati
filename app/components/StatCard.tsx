...
export default function StatCard({
  ...
  return (
    <div
      className={`${c.bg} md:backdrop-blur-xl border ${c.border} shadow-lg rounded-2xl p-3 md:p-5 transition-all duration-300 hover:scale-[1.02] hover:-translate-y-0.5 hover:shadow-xl`}
    >
