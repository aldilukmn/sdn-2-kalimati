...
export default function Toast({
  ...
  return (
    <div
      className={`fixed top-4 right-4 w-[66vw] md:w-auto z-50 flex flex-col border ${borderColor} ${bgColor} md:backdrop-blur-xl ${textColor} rounded-2xl shadow-lg animate-slide-in-right md:max-w-sm overflow-hidden`}
    >
      <div className="flex items-center gap-3 px-4 pt-3 pb-2.5">
        <p className="text-xs md:text-sm font-medium flex-1 leading-relaxed">
          {message}
        </p>
        <button
          onClick={onClose}
