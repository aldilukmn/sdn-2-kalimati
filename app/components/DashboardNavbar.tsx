...
export default function DashboardNavbar({ onMenuClick }: NavbarProps) {
  return (
    <header className="sticky top-0 z-30 bg-slate-100/95 md:bg-slate-100/90 dark:bg-slate-800/90 md:backdrop-blur-xl border-b border-indigo-300 dark:border-slate-700">
