...
## Summary
- 1161 nodes · 2789 edges · 88 communities (53 shown, 35 thin omitted)
...
- `WeeklyRecapTable()` --calls--> `formatCompactRupiah()`  [EXTRACTED]
  components/tabungan/WeeklyRecapTable.tsx → lib/format.ts
...
Cohesion: 0.40
Nodes (3): dataKelulusan, dataKelulusanType, Card()
...
Cohesion: 0.06
Nodes (48): TabunganSection(), TabunganMuridPage(), MONTHS_SHORT, Props, SavingsTrendChart(), LoadingDots(), YearSelect(), ModalProps (+40 more)

### Community 5 - "character-assessment.service.ts"
Cohesion: 0.07
Nodes (30): DashboardKarakterPage(), KonfigurasiKaihPage(), Modal, KarakterDetailPage(), PenilaianKarakterPage(), HabitRadioGroup(), HabitRadioGroupProps, OPTIONS (+22 more)

### Community 6 - "IncompleteDataWidget.tsx"
Cohesion: 0.07
Nodes (34): Props, AdminDashboardView(), AttendanceDonutChart, GuruDashboardView(), DataMuridPage(), AttendanceTrendChart(), MONTHS_SHORT, Props (+26 more)
...
Cohesion: 0.17
Nodes (14): Props, Props, ScoreService, StudentAttendanceService, BulkScoreItem, BulkScoreRequest, Chapter, ChapterProgress (+6 more)

### Community 9 - "Pagination.tsx"
Cohesion: 0.17
Nodes (7): HabitDisplay, SCORE_COLORS, VALUE_COLORS, gameLinks, tariLinks, TypeTariLinks, BackButton()
...
Cohesion: 0.18
Nodes (11): MasterStrukturPage(), useChapters(), api(), getCookie(), ChapterService, MaterialService, ChapterCreateRequest, ChapterUpdateRequest (+3 more)

### Community 15 - "StudentDataStep.tsx"
Cohesion: 0.06
Nodes (44): EditRegistration(), emptyForm, DataPendaftar(), formatDateTime(), initialFormData, Pmb(), DatePickerFieldProps, HolidayInfoCard() (+36 more)

### Community 17 - "cn"
Cohesion: 0.25
Nodes (14): DailyPresensiView(), AssignTabProps, SubjectsTabProps, SCORE_COLORS, WeeklyRecapTable(), WeeklyRecapTableProps, Table(), TableBody() (+6 more)

### Community 19 - "grade-subject.service.ts"
Cohesion: 0.16
Nodes (10): useSubjects(), GradeSubjectService, SubjectService, BulkGradeSubjectCreateRequest, GradeSubjectCreateRequest, GradeSubjectQueryParams, GradeSubjectUpdateRequest, Subject (+2 more)
...
Cohesion: 0.05
Nodes (37): DashboardClient(), DashboardPage(), AdminLayout(), metadata, ProfileView(), Props, ROLE_COLORS, ROLE_LABELS (+29 more)
...
Cohesion: 0.18
Nodes (14): NilaiAkhirPage(), RekapNilaiAkhirPage(), Props, useFinalScore(), MatrixRow, SubjectColumn, useRekapNilaiAkhir(), ACADEMIC_YEARS (+6 more)
...
Cohesion: 0.11
Nodes (13): Modal, Modal, Modal, PaginationProps, PageHeroProps, EmptyStateProps, ErrorStateProps, FilterBarProps (+5 more)

### Community 43 - ".getAll"
Cohesion: 0.33
Nodes (5): NilaiHarianPage(), RekapNilaiPage(), useHarianData(), useNilaiHarian(), useRekapNilai()

### Community 57 - "IncompleteDataWidget.tsx"
Cohesion: 0.15
Nodes (13): AttendanceTrendChart, AttendanceTrendWidget(), AttendanceTrendWidgetProps, PresensiStatCards(), PresensiStatCardsProps, AttendanceDonutChart, DateDayPicker(), DateDayPickerProps (+5 more)

### Community 85 - "export-presensi-csv.ts"
Cohesion: 0.05
Nodes (40): DashboardPresensiPage(), emptyForm, FormData, Modal, ROLE_OPTIONS, ConfirmDialog(), Modal, DataGTK() (+32 more)

### Community 86 - "dashboard-akademik/page.tsx"
Cohesion: 0.18
Nodes (8): NilaiStatCards(), NilaiStatCardsProps, RecentActivities(), RecentActivitiesProps, RecentActivity, GlassColors, SimpleColors, StatCardProps

### Community 87 - "cn"
Cohesion: 0.14
Nodes (17): geist, metadata, poppins, RootLayout(), ThemeProvider(), Button(), buttonVariants, CardAction() (+9 more)
